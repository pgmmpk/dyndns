...
page.open(ADDRESS, function (status) {
    if (status == 'success') {
        ...
        page.includeJs("http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js", function() {
        	...
        	//
    		// since form has child input element named 'submit' one can not
    		// use input.form.submit() call to submit form using JS. Hence
        	// I will collect all form content and then issue a separate POST request.
        	...
        	page.open(ADDRESS, 'post', formEncode(f), function() {
                ...
                page.includeJs("http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js", function() {
                	var navText = page.evaluate(function() { return $('#topnav').text(); }).trim();
